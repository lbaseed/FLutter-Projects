...
import 'package:drivers_app/assistance/assistant_methods.dart';
...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  void displayRequestingRideContainer() {
    setState(() {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          //bottom banner search Container
          Positioned(
            left: 0.0,
            right: 0.0,
            bottom: 0.0,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  ((tripDirectionDetails != null)
                                      ? "\NGN ${AssistantMethods.calculateFares(tripDirectionDetails!)}"
                                      : ""),
                                  style: TextStyle(
                                      fontSize: 16.0,
                                      fontFamily: "Brand-Bold")),
                      ...
                      child: DefaultTextStyle(
                        ...
                        child: AnimatedTextKit(
                          ...
                          animatedTexts: [
                            ...
                            ScaleAnimatedText('Finding a Driver nearby...'),
                            ScaleAnimatedText('Please Wait a little...'),
                          ],
                          onTap: () {
                            print("Tap Event");
                          },
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(width: 2.0, color: Color(0xFFB3B3AE)),
                        ),
                        child: Icon(
                          Icons.close,
                          size: 26.0,
  ...
  Future<void> getPlaceDirection() async {
    ...
    Circle pickUpLocCircle = Circle(
        circleId: CircleId("picUpCircleID"),
